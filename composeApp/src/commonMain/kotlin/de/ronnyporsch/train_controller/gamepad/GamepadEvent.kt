...
sealed class GamepadEvent(open val gamepadIndex: Int) {
    ...
    data class LeftTriggerMoved(override val gamepadIndex: Int, val value: Float) : GamepadEvent(gamepadIndex)
    data class RightTriggerMoved(override val gamepadIndex: Int, val value: Float) : GamepadEvent(gamepadIndex)
